...
def leaves_visualizer_page_body():
    ...
    st.info(
        ...
        f"in conducting a study to visually differentiate a healthy cherry \n"
        f"leaf from one with powdery mildew**.\n\n"
        f"This page shows the visual difference between a healthy cherry\n"
        f"leaf and one affected by powdery mildew.\n\n"
    )
    ...
    if st.checkbox("Difference between average and variability image"):
        ...
        st.warning(
            ...
            f"patterns where we can intuitively differentiate one from another"
            f"However, mildew infected leaves have powdery looking patches.")
    ...
    if st.checkbox("Average infected versus Average healthy leaves"):
        diff_between_avgs = plt.imread(f"outputs/{version}/avg_diff.png")

        st.warning(
            f"The difference in color between the healthy\n"
            f"leaves and those infected by mildew is clear.\n"
