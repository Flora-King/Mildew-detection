...
def summary_page_body():
    ...
    st.info(
        ...
        f"The process used by Farmy & Foods to verify the presence of powdery\n"
        ...
        f"mildew. If there is powdery mildew, the employee spends 1 minute applying a specific compound to kill the fungus.\n"
